...
"[project]/app/api/users/search/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const users = await db.collection("users").find({
            _id: {
                $ne: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](session.userId)
            },
            $or: [
                {
                    name: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0dd4da03._.js.map